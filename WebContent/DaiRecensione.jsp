<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.*,model.utente.giocatore.*,model.recensione.*,model.utente.gestore.*"%>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="heading_<%=i %>">
					<button class="accordion-button collapsed" type="button"
						...
						<%=giocatore %>
						<span class="badge bg-primary" style="margin-left: 5px;">Da
							recensire</span>
					</button>
				</h2>
					...
					<div class="accordion-body">
						<form id="dairecensione" action="recensione" method="post"
							...
							<div class="mb-3">
								...
								<input type="number" class="form-control" name="valutazione"
									id="valutazione" min="1" max="5" step=".5"
									aria-describedby="valutazione" required>
								<div id="valutazioneHelp" class="form-text">Dai una
									valutazione da 1 a 5</div>
							</div>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="heading_recensito_<%=i %>">
					<button class="accordion-button collapsed" type="button"
						...
						data-bs-target="#collapse_recensito_<%=i %>" aria-expanded="false"
						aria-controls="collapse_recensito_<%=i %>">
						<%=recensione.getRecensito()%>
						<span class="badge bg-success" style="margin-left: 5px;">recensito</span>
					</button>
				</h2>
				<div id="collapse_recensito_<%=i %>"
					class="accordion-collapse collapse"
					aria-labelledby="heading_recensito_<%=i %>"
					data-bs-parent="#accordionExampleRecensito">
					<div class="accordion-body">
						<form id="dairecensione" method="post" action="recensione"
							...
							<div class="mb-3">
								...
								<input type="number" class="form-control"
									value="<%=recensione.getRecensione()%>" name="valutazione"
									id="valutazione" min="1" max="5" step=".5"
									aria-describedby="valutazione" readonly>
								<div id="valutazioneHelp" class="form-text">Dai una
									valutazione da 1 a 5</div>
							</div>
							...
							<div class="mb-3">
								<label for="descrizione" class="form-label">Descrizione</label>
								<textarea class="form-control" name="descrizione"
									id="descrizione" readonly><%=recensione.getDescrizione()%></textarea>
								<p id="errDescrizione"></p>
							</div>
