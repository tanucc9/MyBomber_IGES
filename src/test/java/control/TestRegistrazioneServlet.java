...
public class TestRegistrazioneServlet {
	...
	public void registrazioneGiocatoreOk() throws ServletException, IOException, SQLException {
		...
		when(gioDao.doRetrieveByKey("cpinoi@pino.it")).thenReturn(null);
		when(gioDao.doRetrieveByUsername("ukipino")).thenReturn(null);
		
		when(req.getAttribute("ceu")).thenReturn(true);
		...
		when(gioDao.doRetrieveByKey(g.getEmail())).thenReturn(g);
	...
	public void registrazioneGiocatoreNo() throws ServletException, IOException {
		...
		when(gioDao.doRetrieveByKey(g.getEmail())).thenReturn(null);
